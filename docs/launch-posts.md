...
Replace every bracketed field with measured evidence before publishing.
...
reference-to-video. Official baseline: [X]. Turbo: [Y]. Turbo + Sol-Attn: [Z].
Same prompt, seed, dimensions, frame count, one warmup + three measured runs.

No hosted service. No model weights in Git. No invented benchmark numbers.

https://github.com/bg-vc/axon-creative-agent
